      ...
      <div className="page artwork-page">
        {artwork ? (
          ...
          <div className="clickable flex direction-column align-center" onClick={handleClick}>
            ...
            <div className="artwork-info"><ArtworkInfo feedback={artwork.feedbackStack} tags={artwork.post_tags} title={artwork.post_title} user={artwork.user} description={artwork.post_description} folders={artwork.folders} /></div>
          </>
        ) : (
          <div>Loading...</div>
        )}
